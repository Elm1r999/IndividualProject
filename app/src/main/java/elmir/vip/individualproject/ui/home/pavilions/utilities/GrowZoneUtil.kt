...
/**
 * A helper function to determine a Pavilion's growing zone for a given latitude.
 *
 * The numbers listed here are roughly based on the United States Department of Agriculture's
 * Pavilion Hardiness Zone Map (http://planthardiness.ars.usda.gov/), which helps determine which
