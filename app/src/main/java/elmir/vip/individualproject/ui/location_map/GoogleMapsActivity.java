...
public class GoogleMapsActivity extends FragmentActivity implements
    ...
    {
        StringBuilder googleURL = new StringBuilder("https://maps.googleapis.com/maps/api/place/findplacefromtext/json?"); //findplacefromtext or nearbysearch
        googleURL.append("location=" + latitide + "," + longitude);
        googleURL.append("&radius=" + ProximityRadius);
        googleURL.append("&type=" + nearbyPlace);
        googleURL.append("&sensor=true");
        googleURL.append("&key=" + "AIzaSyDQrUrFnKt19Pjpb2b5klgSgs6CMx_co8c"); //my apikey: AIzaSyDQrUrFnKt19Pjpb2b5klgSgs6CMx_co8c *** testkey: AIzaSyDtIWXQDUA1ufc_Vff3qbz522DnZ26Nk9w
